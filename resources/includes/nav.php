  <div class="mdl-layout__drawer mdl-color--blue-grey-800 mdl-color-text--blue-grey-50">
       <div class="profile">
           ...
           <br/>
           <h4>Kim Santoyo</h4>           
           <span>ksant972@mtroyal.ca</span>
       </div>

    <nav class="mdl-navigation mdl-color-text--blue-grey-300">
        <a href="index.php" class="mdl-navigation__link mdl-color-text--blue-grey-300" href=""><i class="material-icons" role="presentation">account_circle</i> User Profile</a>
