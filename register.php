...
<body>
<form method="post" action="process.php" id="mainForm">
   <fieldset>
      <legend id="legend">Registering a New User</legend>
      <table>
         <tr>
            <td colspan="2">
               <p>
               ...
               <input type="password" name="password" id="password" class="required hilightable">
               </p>
               <p>
               <label>Confirm Password</label><br/>
               <input type="password" name="passwordmatch" id="passwordmatch" class="required hilightable">
               </p>
               <div id="checkPasswords">
               </div>
            </td>
            </tr>
            <tr>
